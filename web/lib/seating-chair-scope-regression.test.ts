...
const migrationSource = readFileSync(
  "prisma/migrations/20260609100000_add_matrixrow_seating_plans/migration.sql",
  "utf8",
);
const scopedAssignmentMigrationSource = readFileSync(
  "prisma/migrations/20260609143000_scope_seating_assignments/migration.sql",
  "utf8",
);
const attendeeBridgeMigrationSource = readFileSync(
  "prisma/migrations/20260624143000_add_seating_attendee_event_bridge/migration.sql",
  "utf8",
);
