...
const schema = readFileSync(resolve(workspaceRoot, "prisma/schema.prisma"), "utf8");
const migration = readFileSync(
  resolve(workspaceRoot, "prisma/migrations/20260818190000_add_expected_attendance_provenance/migration.sql"),
  "utf8",
);
const sessionService = readFileSync(resolve(import.meta.dirname, "matrix2-session.ts"), "utf8");
const sessionRoute = readFileSync(
  resolve(workspaceRoot, "web/app/api/events/[eventId]/matrix-2/sessions/[sessionId]/route.ts"),
  "utf8",
);
const workspace = readFileSync(
  resolve(workspaceRoot, "web/app/(shell)/events/[eventId]/matrix/sessions/[sessionId]/_components/session-detail-workspace.tsx"),
  "utf8",
);
