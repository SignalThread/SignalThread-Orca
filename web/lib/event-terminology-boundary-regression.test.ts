...
test("terminology migration is additive, mirrored, and database-constrained", () => {
  const root = readFileSync("../prisma/migrations/20260811190000_event_display_terminology/migration.sql", "utf8");
  const web = readFileSync("prisma/migrations/20260811190000_event_display_terminology/migration.sql", "utf8");
