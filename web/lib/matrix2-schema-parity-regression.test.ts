...
const rootRepairMigration = "../prisma/migrations/20260729140000_restore_session_staff_assignment/migration.sql";
const webRepairMigration = "prisma/migrations/20260729140000_restore_session_staff_assignment/migration.sql";
const rootSlice4Migration = "../prisma/migrations/20260729150000_slice4_session_authorities/migration.sql";
const webSlice4Migration = "prisma/migrations/20260729150000_slice4_session_authorities/migration.sql";
const rootEventPersonRoleRepair = "../prisma/migrations/20260730120000_repair_event_person_role_enum/migration.sql";
const webEventPersonRoleRepair = "prisma/migrations/20260730120000_repair_event_person_role_enum/migration.sql";
