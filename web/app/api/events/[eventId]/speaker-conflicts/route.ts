...
} from "@/src/server/services/speaker-conflicts";
...
async function getHandler(
  ...
  try {
    const overview = await getSpeakerConflicts(eventId, authResult.user);
    return NextResponse.json(overview);
  } catch (error) {
    return toErrorResponse(error, "GET /api/events/:eventId/speaker-conflicts");
  }
}

export const GET = withApiRequestLogging("GET /api/events/:eventId/speaker-conflicts", getHandler);
