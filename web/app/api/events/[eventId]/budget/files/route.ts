...
import { BudgetServiceError, listBudgetFilesForEvent } from "@/src/server/services/budget";
...
async function getHandler(
  ...
  try {
    ...
    const payload = await listBudgetFilesForEvent(eventId, {
    ...
    return toErrorResponse(error, "GET /api/events/:eventId/budget/files");
  }
}

export const GET = withApiRequestLogging("GET /api/events/:eventId/budget/files", getHandler);
