---
title: Running a Kiosk Survey
description: How the kiosk flow works from consent through recording, playback, and completion.
sidebar:
  order: 5
---
...
- [QR Codes: View, Download, and Share](/help/surveys/qr-codes/)
