...
import { SeatingError, unassignAttendee } from "@/lib/seating";
...
async function postHandler(
  ...
  try {
    ...
    await unassignAttendee(eventId, attendeeId, {
      matrixRowId,
      seatingPlanId,
    ...
    return toErrorResponse(error, "POST /api/events/:eventId/seating/unassign");
  }
}

export const POST = withApiRequestLogging("POST /api/events/:eventId/seating/unassign", postHandler);
